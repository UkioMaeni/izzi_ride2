...
List<String> upText=[
"Don't have a vehicle, but planning a trip and looking for a ride?",
"Going on a trip on your vehicle and don't know how to save on it? It's easy!",
...
List<Widget> images=[
        Column(
          ...
          children: [
            const Text("Find a ride with verified profiles. Choose a vehicle model and a comfortable time for your ride. It's easy!",style: TextStyle(color: Colors.white,fontFamily: "SF",fontSize: 18,fontWeight: FontWeight.w400,height: 1)),
          ],
          )
        , 
        Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text("After you've arrived at the final destination, go to the app and rate your ridemates. Share your experience. Let others know more about your ridemates. Make your trip more rewarding with iZZi Ride.",style: TextStyle(color: Colors.white,fontFamily: "SF",fontSize: 18,fontWeight: FontWeight.w400,height: 1)),
