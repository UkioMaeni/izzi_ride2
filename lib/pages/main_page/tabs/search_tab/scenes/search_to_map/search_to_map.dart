...
class SearchToMap extends StatefulWidget {
  const SearchToMap({super.key});

  @override
  State<SearchToMap> createState() => _SearchToMapState();
}

class _SearchToMapState extends State<SearchToMap> {
                  ...
                  child: UIButton(label: "Next",
                    onTap: () {
                      ...
                      Location location = Location(
                        ...
                        context.read<SearchRideBloc>().add(SearchRideSetToLocation(location: location));
                        inspect(location);
                        setState(() {
                          isLockedButton=false;
                        });
